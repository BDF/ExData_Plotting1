...
plot(pcdt$Sub_metering_1 ~ pcdt$DateTime, type="n", ylab="Energy sub metering", xlab="")
lines(pcdt$Sub_metering_1 ~ pcdt$DateTime, col="black")
lines(pcdt$Sub_metering_2 ~ pcdt$DateTime, col="red")
lines(pcdt$Sub_metering_3 ~ pcdt$DateTime, col="blue")
